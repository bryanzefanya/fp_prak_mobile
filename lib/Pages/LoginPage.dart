...
class _LoginPageState extends State<LoginPage> {
  ...
  checkLoginStatus() async {
    ...
    if (newUser == false) {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => HeroListPage()));
    }
  }
  ...
  void printHashForAdminPassword() {
    String hashedPassword = calculateMD5('sugeng');
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (_usernameController.text == 'sugeng' &&
                              _passwordController.text == 'sugeng') {
